...
import { assignRemoveItemsFromCategory, createCategory, createItem, getAllOrders, getOrder, retireItem, updateItem } from '../controllers/adminController.js';
...
router.put('/orders/:orderId/:status') //change order status to :status that is passed
